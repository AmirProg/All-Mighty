...
* Inspired by (c) Thor
*
* You have to choose how accurate the stop watch will be in the constructor (count seconds, milliseconds or microseconds)
*
*/
...
public:
    ...
    enum Accuracy { Seconds, Milliseconds, Microseconds, MAX };
